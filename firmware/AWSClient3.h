...
#ifndef AWSCLIENT3_H_
#define AWSCLIENT3_H_
...
public:
    void setKey(MinimalString key);
    void setBucket(MinimalString bucket);
    MinimalString getKey() const;
    MinimalString getBucket() const;
